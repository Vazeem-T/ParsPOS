...
namespace ParsPOS.Services.BackendView
{
	public class DynamicBottomSheet
	{
		public View GenerateBottomSheetContent()
		{
			...
			var border1 = new Border
			{
				...
				BackgroundColor = (Color)App.Current.Resources["AliceBlue"],
				Stroke = (Color)App.Current.Resources["Black"],
				StrokeThickness = 0.2
			};
			...
			var label1 = new Label
			{
				...
				TextColor = (Color)App.Current.Resources["Gray600"],
			...
			{
				Stroke = (Color)App.Current.Resources["DarkBg1"],
